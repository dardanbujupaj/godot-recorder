...
GDCALLINGCONV void *exporter_constructor(godot_object *p_instance, void *p_method_data);
GDCALLINGCONV void exporter_destructor(godot_object *p_instance, void *p_method_data, void *p_user_data);
godot_variant exporter_get_data(godot_object *p_instance, void *p_method_data, void *p_user_data, int p_num_args, godot_variant **p_args);
...
void GDN_EXPORT godot_nativescript_init(void *p_handle) {
	...
	create.create_func = &exporter_constructor;

	godot_instance_destroy_func destroy = { NULL, NULL, NULL };
	destroy.destroy_func = &exporter_destructor;
	...
	nativescript_api->godot_nativescript_register_class(p_handle, "EXPORTER", "Reference", create, destroy);

	godot_instance_method get_data = { NULL, NULL, NULL };
	get_data.method = &exporter_get_data;
	...
	nativescript_api->godot_nativescript_register_method(p_handle, "EXPORTER", "get_data", attributes, get_data);
}
